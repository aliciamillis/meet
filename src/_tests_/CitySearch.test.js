...
describe('<CitySearch /> component', () => {
  ...
  test('get a list of cities when the user searches for Berlin', () => {
    const CitySearchWrapper = mount(<CitySearch locations={locations} updateEvents={() => { }} />);
  ...
  test('renders a list of suggestions correctly', () => {
    ...
    CitySearchWrapper.find('input[type="text"]').simulate('change', { target: { value: 'Berlin' } });
  ...
  test('selecting a suggestion should change query state', () => {
    const CitySearchWrapper = shallow(<CitySearch updateEvents={() => { }} locations={locations} />);
    CitySearchWrapper.setState({ suggestions: locations });
    CitySearchWrapper.find('input[type="text"]').simulate('change', { target: { value: 'London' } });
    CitySearchWrapper.find('.suggestions li').at(0).simulate('click');
